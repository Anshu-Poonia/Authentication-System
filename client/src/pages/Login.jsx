    ...
    <div className="flex items-center justify-center min-h-screen px-6 sm:px-0 bg-linear-to-br from-blue-200 to-purple-400">
      ...
      <div className="bg-slate-900 p-10 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm">
        ...
        <form className="flex flex-col items-center" onSubmit={onSubmitHandler}>
          ...
          <button className="w-full mt-3 py-2.5 rounded-full bg-linear-to-br from-blue-500 to-purple-900 text-white font-medium hover:bg-indigo-700 transition duration-300">
            {state}
          </button>
        </form>
